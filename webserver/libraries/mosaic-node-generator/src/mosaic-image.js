...
var MosaicImage = /** @class */ (function () {
    function MosaicImage(image, urls, cellWidth, cellHeight, columns, rows, enableConsoleLogging) {
    ...
    MosaicImage.prototype.getTiles = function (urls) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            ...
            _urls.forEach(function (url) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, jimp_image_1.JimpImage.read(url)["catch"](function (err) { if (_this.enableConsoleLogging)
